...
// // //           title: "Proven Conversion Operating System (COS) Framework",
...
// // //         <div className="container">
// // //           <h2>Why Every InsurTech Founder Needs Conversion Operating System (COS) Right Now</h2>
// // //           <div className="why-cos-matters">
// // //             <div className="why-cos-intro">
// // //               <p>Most InsurTech startups aren't failing because of product, they're stalling because their go-to-market engine is built on guesswork. Sales is manual. Marketing is scattered. RevOps is missing entirely. And the founder is still doing everything.</p>
// // //               <p>Revenue growth is slow, messaging is unclear, and teams can't tell what's actually working.</p>
...
// //   // ─── 4 confirmed services (text sourced directly from Kerry's website) ──────
// //   const services = [
// //     {
// //       num: '01',
// //       title: 'Go-To-Market & Revenue Foundation',
// //       img: '/service-gtm.jpg',
// //       desc: 'We build the revenue engine that turns vision into velocity. For early-stage InsurTech and scaling companies, success depends on getting GTM right from day one. We help founders define their ideal market, sharpen their positioning, and architect sales systems designed for repeatable growth. Whether launching an offering or re-aligning a maturing organization, we integrate strategy, messaging, AI-enabled workflows, and disciplined execution to create clarity and momentum.',
// //       bullets: ['Clear differentiation & market positioning', 'Predictable pipeline development', 'AI-enabled GTM workflows', 'Scalable revenue foundation'],
// //     },
// //     {
// //       num: '02',
// //       title: 'Revenue Acceleration & Operational Alignment',
// //       img: '/service-sales.jpg',
// //       desc: 'We fix stalled growth and transform complexity into performance. As companies scale, misalignment between strategy, sales, marketing, and operations slows momentum. We diagnose friction points across the funnel and rebuild the systems that drive measurable results. From revenue operations design to AI-enabled GTM execution, we align teams, data, and process to shorten sales cycles, increase conversion, and improve visibility across the revenue engine.',
// //       bullets: ['Revenue operations design', 'Funnel friction diagnosis & repair', 'Improved conversion rates', 'Faster revenue velocity'],
// //     },
// //     {
// //       num: '03',
// //       title: 'Strategic Advisory & Fractional CRO Leadership',
// //       img: '/service-cro.jpg',
// //       desc: 'Executive revenue leadership for inflection moments. InsurTech founders and boards turn to us during critical transitions, capital raises, acquisitions, post-merger integration, or rapid scale. We provide senior-level revenue strategy and hands-on execution without the overhead of a full-time CRO. Our role is to bring clarity, accountability, and forward momentum when the stakes are highest.',
// //       bullets: ['Stronger enterprise value', 'Aligned leadership teams', 'Confident decision-making at every growth stage'],
// //     },
...
// //           background: 'linear-gradient(90deg, #1e3a5f 0%, #00B89F 100%)',
// //           zIndex: 10000, transition: 'width 0.1s ease-out',
// //           boxShadow: '0 0 10px rgba(0, 184, 159, 0.5)',
// //         }}
// //       />
...
// //           <div className="why-gtm-features-grid">
// //             {[
// //               { img: '/expertise-card.jpg',   title: 'Deep Insurance & Tech Expertise',                    desc: 'Enterprise tech, underwriting, and sales knowledge combined' },
// //               { img: '/framework-card.jpg',   title: 'Proven Conversion Operating System (COS) Framework', desc: 'We build systems that align message, motion, and market' },
// //               { img: '/ai-enabled-card.jpg',  title: 'AI-Enabled Execution',                               desc: 'Leveraging AI and proven frameworks for competitive edge' },
// //               { img: '/results-card.jpg',     title: 'Real-World Growth',                                  desc: 'Hands-on support built for real-world growth' },
// //             ].map((f, i) => (
// //               <div key={i} className="why-gtm-feature-card">
// //                 <div className="feature-image"><img src={f.img} alt={f.title} /></div>
// //                 <h3>{f.title}</h3>
// //                 <p>{f.desc}</p>
// //               </div>
// //             ))}
...
// //           {/* ── NEW: What We Offer ── */}
// //           <h2 className="services-offer-heading">
// //             What We Offer
// //           </h2>
// //           <p className="services-offer-subtitle">
// //             Practical, hands-on services designed to build your revenue engine and accelerate growth.
// //           </p>

// //           <div className="services-offer-grid">
// //             {services.map((s, i) => (
// //               <div key={i} className="service-offer-card">
...
// //             <a href="https://calendly.com/kerry-gtm-collective/30min" className="cta-button">
...
// //             <span>The How — Our Conversion Operating System</span>
// //           </div>

// //           {/* ── Existing: Why COS ── */}
// //           <h2 style={{ color: 'white', WebkitTextFillColor: 'white' }}>
// //             Why Every InsurTech Founder Needs COS Right Now
// //           </h2>
// //           <div className="why-cos-matters">
// //             <div className="why-cos-intro">
// //               <p>Most InsurTech startups aren't failing because of product, they're stalling because their go-to-market engine is built on guesswork. Sales is manual. Marketing is scattered. RevOps is missing entirely. And the founder is still doing everything.</p>
...
// //           <div className="client-types-grid">
// //             {[
// //               { title: 'InsurTech Founders',                      desc: 'InsurTech founders still leading sales',                               image: '/founder-persona.jpg',  icon: 'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z' },
// //               { title: 'CEOs Brought in to Scale Go-To-Market',   desc: 'Experienced executives scaling revenue operations',                     image: '/ceo-persona.jpg',      icon: 'M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z' },
// //               { title: 'Growth-Stage B2B Insurance Platforms',    desc: 'Seed to Series B startups with broken handoffs and siloed teams',       image: '/platform-persona.jpg', icon: 'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z' },
// //             ].map((item, idx) => (
// //               <div key={idx} className="client-type-card">
// //                 <div className="persona-image-top">
// //                   <img src={item.image} alt={item.title} />
...
// //             <h3>Speaking Engagements</h3>
// //             <p>Kerry is available to speak at industry conferences and seminars, as well as lead or host client councils, advisory boards, and other professional gatherings. Whether it's sharing her insights and knowledge of industry topics or trends, or her perspective on the vision and future of insurance, Kerry will create an impactful and insightful experience for attendees.</p>
// //             <a href="mailto:kerry@gtmcollective.com?subject=Speaking Inquiry" className="speaking-cta-button">
// //               Request Kerry as a Speaker
// //             </a>
// //           </div>
// //           <div className="speaking-grid">
...
// //             ].map((s, idx) => (
// //               <div key={idx} className="speaking-card">
// //                 <div className="speaking-image"><img src={s.img} alt={s.title} /></div>
// //                 <div className="speaking-content">
// //                   <h3>{s.title}</h3>
// //                   <p>{s.desc}</p>
// //                 </div>
...
// import { useEffect, useState } from 'react';
// import Link from 'next/link';
// <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700;900&display=swap" rel="stylesheet"></link>
// export default function Home() {
//   const [scrolled, setScrolled] = useState(false);
//   const [scrollProgress, setScrollProgress] = useState(0);
...
//       img: '/service-gtm.jpg',
//       desc: 'We build the revenue engine that turns vision into velocity. For early-stage InsurTech and scaling companies, success depends on getting GTM right from day one. We help founders define their ideal market, sharpen their positioning, and architect sales systems designed for repeatable growth. Whether launching an offering or re-aligning a maturing organization, we integrate strategy, messaging, AI-enabled workflows, and disciplined execution to create clarity and momentum.',
//       bullets: ['Clear differentiation', 'Predictable pipeline', 'Scalable revenue foundation built for long-term growth'],
//     },
//     {
//       num: '02',
//       title: 'Revenue Acceleration & Operational Alignment',
//       img: '/service-sales.jpg',
//       desc: 'We fix stalled growth and transform complexity into performance. As companies scale, misalignment between strategy, sales, marketing, and operations slows momentum. We diagnose friction points across the funnel and rebuild the systems that drive measurable results. From revenue operations design to AI-enabled GTM execution, we align teams, data, and process to shorten sales cycles, increase conversion, and improve visibility across the revenue engine.',
//       bullets: ['Improved conversion rates', 'Faster revenue velocity', 'Disciplined execution across the organization'],
//     },
//     {
//       num: '03',
//       title: 'Strategic Advisory & Fractional CRO Leadership',
...
//               <span className="logo-text-gtm">GTM</span>
//               <span className="logo-text-collective">COLLECTIVE</span>
//             </span>
//           </Link>
//           <div className="nav-links">
//             <a href="#why-gtm">Why GTM</a>
...
//           <div className="why-gtm-features-grid">
//             {[
//               { img: '/expertise-card.webp',   title: 'Deep Insurance & Tech Expertise',                    desc: 'Enterprise tech, underwriting, and sales knowledge combined' },
//               { img: '/framework-card.webp',   title: 'Proven Conversion Operating System (COS) Framework', desc: 'We build systems that align message, motion, and market' },
//               { img: '/ai-enabled-card.webp',  title: 'AI-Enabled Execution',                               desc: 'Leveraging AI and proven frameworks for competitive edge' },
//               { img: '/results-card.jpg',     title: 'Real-World Growth',                                  desc: 'Hands-on support built for real-world growth' },
//             ].map((f, i) => (
//               <div key={i} className="why-gtm-feature-card">
//                 <div className="feature-image"><img src={f.img} alt={f.title} /></div>
...
//           <div className="client-types-grid">
//             {[
//               { title: 'InsurTech Founders',                      desc: 'InsurTech founders still leading sales',                               image: '/founder-persona.webp',  icon: 'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z' },
//               { title: 'CEOs Brought in to Scale Go-To-Market',   desc: 'Experienced executives scaling revenue operations',                     image: '/ceo-persona.webp',      icon: 'M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z' },
//               { title: 'Growth-Stage B2B Insurance Platforms',    desc: 'Seed to Series B startups with broken handoffs and siloed teams',       image: '/platform-persona.webp', icon: 'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z' },
//             ].map((item, idx) => (
//               <div key={idx} className="client-type-card">
//                 <div className="persona-image-top">
//                   <img src={item.image} alt={item.title} />
...
//           <div className="speaking-grid">
//             {[
//               { img: '/insurtech.webp',              title: 'Shaping the Future of InsurTech',                  desc: 'As a go-to-market strategist with decades of experience across insurance and enterprise technology, I bring a practical, real-world lens to InsurTech stages. I speak on the industry challenges and how to overcome them with clarity, alignment, and speed. Whether addressing founders, product leaders, or sales teams, my goal is to move conversations from abstract strategy to executable action.' },
//               { img: '/WIIT Conference Panel.webp',   title: 'Championing Women in Insurance and Tech',          desc: "I'm passionate about helping women step into leadership with confidence and conviction. I speak at industry events focused on elevating women in insurance and technology, sharing the lessons I've learned from the boardroom to the front lines of GTM. Through candid storytelling and actionable takeaways, I empower women to lead authentically, build influence, and drive meaningful change." },
//               { img: '/RISE Professional Panel.jpg', title: 'Inspiring the Next Generation of Leaders',         desc: "One of the most rewarding parts of my work is mentoring and speaking to emerging professionals through organizations like RISE Professional. I help early-career talent understand how to navigate the industry, position themselves for leadership, and build careers aligned with who they are. My talks are designed to spark ambition, build resilience, and remind young professionals that their voice matters now more than ever." },
//             ].map((s, idx) => (
//               <div key={idx} className="speaking-card">
//                 <div className="speaking-image"><img src={s.img} alt={s.title} /></div>
  ...
  return (
    <>
      ...
      <nav id="navbar" className={scrolled ? 'scrolled' : ''}>
        <div className="nav-container">
          <Link href="/" className="logo">
            <Image src="/logo.jpg" alt="GTM Collective Logo" className="logo-img" width={55} height={55} priority />
            <span className="logo-text">
              <span className="logo-text-gtm">GTM</span>
              <span className="logo-text-collective">COLLECTIVE</span>
            </span>
        ...
        <div className="container">
          ...
          <div className="why-gtm-features-grid">
            {[
              ...
              <div key={i} className="why-gtm-feature-card">
                <div className="feature-image">
                  <Image src={f.img} alt={f.title} width={300} height={180} />
                </div>
                <h3>{f.title}</h3>
                <p>{f.desc}</p>
              </div>
      ...
      <section id="services" className="why-cos-matters-section">
        <div className="container">
          ...
          <div className="services-offer-grid">
            {services.map((s, i) => (
              <div key={i} className="service-offer-card">
                <div className="service-card-image">
                  <Image src={s.img} alt={s.title} width={360} height={220} />
                </div>
                <div className="service-card-body">
                  <div className="service-number">{s.num}</div>
                  <h3>{s.title}</h3>
        ...
        <div className="container" style={{ marginTop: '100px' }}>
          ...
          <div className="cos-framework-visual">
            <Image src="/cos-framework-diagram.jpg" alt="Conversion Operating System Framework" width={1200} height={600} />
          </div>
          <div className="cos-framework-grid">
            {[
              { num: 1, title: 'Signal Scan',                       desc: 'Revenue Engine Diagnose your GTM and sales performance to identify conversion gaps and systemic bottlenecks.' },
        ...
        <div className="container">
          ...
          <div className="client-types-grid">
            {[
              { title: 'InsurTech Founders',                    desc: 'InsurTech founders still leading sales',                         image: '/founder-persona.webp', icon: 'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z' },
              { title: 'CEOs Brought in to Scale Go-To-Market', desc: 'Experienced executives scaling revenue operations',               image: '/ceo-persona.webp',     icon: 'M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z' },
              { title: 'Growth-Stage B2B Insurance',  desc: 'Seed to Series C startups with broken handoffs and siloed teams', image: '/platform-persona.webp',icon: 'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z' },
            ].map((item, idx) => (
              <div key={idx} className="client-type-card">
                <div className="persona-image-top">
      ...
      <section id="speaking" className="speaking-premium">
        <div className="container">
          ...
          <div className="speaking-cta-box">
            <h3>Speaking Engagements</h3>
            <p>Kerry is available to speak at industry conferences and seminars, as well as lead or host client councils, advisory boards, and other professional gatherings. Whether it's sharing her insights and knowledge of industry topics or trends, or her perspective on the vision and future of insurance, Kerry will create an impactful and insightful experience for attendees.</p>
            <a href="mailto:kerry@gtm-collective.com?subject=Speaking Inquiry" className="speaking-cta-button">
              Request Kerry as a Speaker
            </a>
          </div>
          <div className="speaking-grid">
            {[
              ...
              <div key={idx} className="speaking-card">
                <div className="speaking-image">
                  <Image src={s.img} alt={s.title} width={400} height={380} />
                </div>
                <div className="speaking-content">
                  <h3>{s.title}</h3>
                  <p>{s.desc}</p>
